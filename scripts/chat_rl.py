...
from nanochat.checkpoint_manager import save_checkpoint, load_model, get_checkpoint_dir
...
for step in range(num_steps):
    ...
    if master_process and ((step > 0 and step % args.save_every == 0) or step == num_steps - 1):
        ...
        model_tag = args.model_tag if args.model_tag else f"d{depth}" # base the model tag on the depth of the base model
        checkpoint_dir = get_checkpoint_dir(model_tag, "rl") # e.g. experiments/<name>/d12/rl
